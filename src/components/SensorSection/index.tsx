...
export default function SensorSection() {
  return (
    <section className="border-t border-[#eeeeee] bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-6xl px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-xl leading-8 text-[#6e6e73]">
            A buried molecular sensor that reads soil water for early biological stress signals.
          </p>
        </div>

        <div className="mx-auto mt-14 max-w-4xl border-x border-[#eeeeee] bg-white">
          <img
            src="/new-sensor.avif"
